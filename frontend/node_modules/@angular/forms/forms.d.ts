...
export declare class MaxValidator extends AbstractValidatorDirective implements OnChanges {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<MaxValidator, "input[type=number][max][formControlName],input[type=number][max][formControl],input[type=number][max][ngModel]", never, { "max": "max"; }, {}, never>;
}
...
export declare class MinValidator extends AbstractValidatorDirective implements OnChanges {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<MinValidator, "input[type=number][min][formControlName],input[type=number][min][formControl],input[type=number][min][ngModel]", never, { "min": "min"; }, {}, never>;
}
